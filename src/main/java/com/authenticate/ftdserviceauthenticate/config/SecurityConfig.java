...
import com.authenticate.ftdserviceauthenticate.config.Gateway.GatewayAuthenticationEntryPoint;
import com.authenticate.ftdserviceauthenticate.config.Gateway.GatewayRequestFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://" + gatewayIp));
